...
// to manage the event assFini
void MAE_COOP_R::MAE_COOP_R_State::Jeu_State::fin_deplacement_lateral_State::assFini(MAE_COOP_R & stm) {
    {
...
void MAE_COOP_R::MAE_COOP_R_State::Jeu_State::bumper_en_bas_des_marches_State::_doentry(MAE_COOP_R & stm) {
  ...
  // on suppose que c'est pas possible qu'il y ait n con qui passe devant...
