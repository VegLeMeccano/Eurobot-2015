...
!!!357250.cpp!!!	time_out(inout stm : MAE_MURPHY) : void
  {
...
!!!357378.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!357506.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!357634.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
