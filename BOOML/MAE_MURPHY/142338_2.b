...
!!!161154.cpp!!!	create(inout stm : MAE_MURPHY) : void
  _doentry(stm);
  {
...
!!!161282.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state._mission_claps_state;
!!!268418.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!329986.cpp!!!	_exit11(inout stm : MAE_MURPHY) : void
  {
