...
#endif
    stm._mae_murphy_state._jeu_state._mission_depot_de_tour_zone_depart_state._prepare_la_pose_state.create(stm!!!219522.cpp!!!	assFini(inout stm : MAE_MURPHY) : void
) : void
  {
...
#endif
    stm._mae_murphy_state._jeu_state._mission_depot_de_tour_zone_depart_state._way_point_initial_state._cap_mission_state.cr!!!219650.cpp!!!	create(inout stm : MAE_MURPHY) : void
E_MURPHY) : void!!!219778.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
...
serialPrintf(master->getPortSerie(),ordre_c)!!!219906.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
MAE_MURPHY) : MAE_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state._mission_depot_de_tour_zone_dep!!!219394.cpp!!!	_exit19(inout stm : MAE_MURPHY) : void
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_depot_de_tour_zone_depart_state._prepare_la_pose_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Jeu.mission depot de tour zone depart.prepare la pose");
