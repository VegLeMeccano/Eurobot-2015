...
!!!157442.cpp!!!	assFini(inout stm : MAE_MURPHY) : void
  {
...
!!!157826.cpp!!!	adversaire(inout stm : MAE_MURPHY) : void
  {
...
!!!157954.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!158082.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!158210.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
