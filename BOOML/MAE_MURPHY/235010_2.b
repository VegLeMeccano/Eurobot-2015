...
!!!349826.cpp!!!	time_out(inout stm : MAE_MURPHY) : void
  {
...
!!!349954.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!350082.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!350210.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
