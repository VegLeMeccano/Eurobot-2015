...
!!!162178.cpp!!!	_completion(inout stm : MAE_MURPHY) : bool

  {
    ...
    return (bool)!!!162306.cpp!!!	create(inout stm : MAE_MURPHY) : void
Y) : void
	_doentry(stm);
	_compl!!!162434.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
: MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
serialPrintf(master->getPortSe!!!162562.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
E_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state._mission_depot_!!!162178.cpp!!!	_completion(inout stm : MAE_MURPHY) : bool
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_depot_tour_estrade_state._depot_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Jeu.mission depot tour estrade.depot");
