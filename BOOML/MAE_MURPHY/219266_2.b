class depot_State
!!!315778.cpp!!!	pince_lache(inout stm : MAE_MURPHY) : void
  {
...
!!!315906.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!316034.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!316162.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
