...
!!!332802.cpp!!!	pince_ouverte(inout stm : MAE_MURPHY) : void
  {
...
!!!332930.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!333058.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!333186.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
