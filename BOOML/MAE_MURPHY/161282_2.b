...
!!!197762.cpp!!!	create(inout stm : MAE_MURPHY) : void
  _doentry(stm);
  {
...
!!!199298.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state;
!!!288770.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!328834.cpp!!!	_exit2(inout stm : MAE_MURPHY) : void
  {
