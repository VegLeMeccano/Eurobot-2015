...
!!!237314.cpp!!!	time_out(inout stm : MAE_MURPHY) : void
  {
...
!!!237442.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!237570.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!237698.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
