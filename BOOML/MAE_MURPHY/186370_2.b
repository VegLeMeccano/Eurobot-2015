...
!!!268546.cpp!!!	create(inout stm : MAE_MURPHY) : void
  _doentry(stm);
  {
...
!!!271106.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!271234.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state._mission_claps_state;
!!!330114.cpp!!!	_exit12(inout stm : MAE_MURPHY) : void
  {
