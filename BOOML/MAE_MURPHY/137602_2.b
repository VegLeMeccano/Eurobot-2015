...
#endif
    stm._mae_murphy_state._jeu_state._mission_pillage_distrib_state._capture_stands_cote_escalier_state._bf_cap_initial_35deg_state.create(st!!!173314.cpp!!!	_exit4(inout stm : MAE_MURPHY) : void
Y) : void
  {
...
#endif
    stm._mae_murphy_state._jeu_state._mission_pillage_distrib_state._capture_stand_bordure_state.c!!!173442.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
...
/// Vert : pile gauche +2
// element_robot.pile_gauche_incr(!!!173570.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
RPHY) : MAE_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state._m!!!168066.cpp!!!	create(inout stm : MAE_MURPHY) : void
  _doentry(stm);
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_pillage_distrib_state._capture_stands_cote_escalier_state._bf_cap_initial_35deg_state);
#ifdef VERBOSE_STATE_MACHINE
