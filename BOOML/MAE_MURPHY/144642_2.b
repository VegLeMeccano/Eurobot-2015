...
!!!198274.cpp!!!	create(inout stm : MAE_MURPHY) : void
	...
	_doentry(stm)!!!198402.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
tm : MAE_MURPHY) : void
...
if(master->is_Vert()){
serialPrintf(ma!!!198530.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
PHY::AnyState
  return &stm._mae_murphy_state._jeu_state._mission_claps_state._chope_!!!245250.cpp!!!	pince_ouverte(inout stm : MAE_MURPHY) : void
_MURPHY) : void
  {
...
#endif
    stm._mae_murphy_state._jeu_state._mission_claps_state._chope_du_coin_state._avance_s!!!245250.cpp!!!	pince_ouverte(inout stm : MAE_MURPHY) : void
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_claps_state._chope_du_coin_state._avance_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Jeu.mission claps.chope du coin.avance");
