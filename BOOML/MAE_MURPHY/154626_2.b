...
!!!242306.cpp!!!	_completion(inout stm : MAE_MURPHY) : bool

  {
    ...
    return (bool)!!!242434.cpp!!!	create(inout stm : MAE_MURPHY) : void
Y) : void
	_doentry(stm);
	_compl!!!242562.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
...
serialPrintf(master->getPortSerie(),"C0 !!!242690.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
Y) : MAE_MURPHY::AnyState
  return &stm._mae_murphy_stat!!!242306.cpp!!!	_completion(inout stm : MAE_MURPHY) : bool
  {
    stm._set_currentState(stm._mae_murphy_state._recalage_initial_state._avance_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Recalage Initial.avance");
