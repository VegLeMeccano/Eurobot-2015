...
!!!210562.cpp!!!	assFini(inout stm : MAE_MURPHY) : void
...
#endif
    stm._mae_murphy_state._jeu_state._mission_rush_zone_centrale_state._waypoint_init_state._bf_droite_to_mission_state.create(stm!!!210690.cpp!!!	create(inout stm : MAE_MURPHY) : void
) : void
	_doen!!!210818.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
m : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
cout<<"ORIENTATION!!!210946.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
MAE_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state._mission_rush_zone_centrale_state.!!!210562.cpp!!!	assFini(inout stm : MAE_MURPHY) : void
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_rush_zone_centrale_state._waypoint_init_state._bf_droite_to_mission_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Jeu.mission rush zone centrale.waypoint init.BF droite to mission");
...
!!!210690.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!210818.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
	puts("DEBUG : execute entry behavior of .MAE_MURPHY.Jeu.mission rush zone centrale.waypoint init.cap to mission");
#endif
// BCAP
...
!!!210946.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
