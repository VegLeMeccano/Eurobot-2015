...
#endif
    stm._mae_murphy_state._jeu_state._mission_depot_tour_estrade_state._bf_cap_state.create(stm!!!163074.cpp!!!	create(inout stm : MAE_MURPHY) : void
) : void
	_doen!!!163202.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
: MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
master->get_gestionnaire_mission()->get_mission_depot_tour_es!!!163330.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
E_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state._mission_depot_!!!162946.cpp!!!	pince_range(inout stm : MAE_MURPHY) : void
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_depot_tour_estrade_state._bf_cap_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Jeu.mission depot tour estrade.BF Cap");
