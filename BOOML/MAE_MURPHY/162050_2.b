...
!!!199682.cpp!!!	_completion(inout stm : MAE_MURPHY) : bool
  {
...
!!!199810.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
	_completion(stm);
!!!199938.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!200066.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
