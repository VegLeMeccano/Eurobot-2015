...
!!!240002.cpp!!!	_junction1(inout stm : MAE_MURPHY) : void
...
#endif
    stm._mae_murphy_state._evitement_state._faire_des_maneuvre_state.create(stm!!!240130.cpp!!!	_exit26(inout stm : MAE_MURPHY) : void
) : void
  {
...
#endif
    stm._mae_murphy_state._jeu_state.cr!!!240770.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
tm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
	puts("DEBUG : execute entry behavior of .MAE_MURPHY.Evitement");
#endif
co!!!240898.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
 MAE_MURPHY::AnyState
  return &!!!240002.cpp!!!	_junction1(inout stm : MAE_MURPHY) : void
  {
    stm._set_currentState(stm._mae_murphy_state._evitement_state._faire_des_maneuvre_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Evitement.faire des maneuvre");
