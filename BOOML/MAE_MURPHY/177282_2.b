...
!!!229378.cpp!!!	pince_ouverte(inout stm : MAE_MURPHY) : void
  {
...
!!!229506.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!229634.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!229762.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
