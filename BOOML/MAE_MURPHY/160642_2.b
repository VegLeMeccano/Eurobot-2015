...
!!!192386.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!192514.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state._mission_depot_de_tour_zone_depart_state;
!!!276866.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
...
// depot de gobelet ?
!!!302338.cpp!!!	pince_lache(inout stm : MAE_MURPHY) : void
  {
