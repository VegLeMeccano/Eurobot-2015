...
#endif
    stm._mae_murphy_state._recalage_initial_state._recule_state.create(st!!!242178.cpp!!!	_exit27(inout stm : MAE_MURPHY) : void
Y) : void
  {
...
#endif
    stm._mae_murphy_state._startin_block_state.c!!!243330.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
	puts("DEBUG : execute entry behavior of .MAE_MURPHY.Recalage Initial");
#endif
cout<<"E!!!243458.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
: MAE_MURPHY::AnyState
  return !!!241026.cpp!!!	create(inout stm : MAE_MURPHY) : void
  _doentry(stm);
  {
    stm._set_currentState(stm._mae_murphy_state._recalage_initial_state._recule_state);
#ifdef VERBOSE_STATE_MACHINE
