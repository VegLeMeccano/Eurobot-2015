...
!!!310914.cpp!!!	_completion(inout stm : MAE_MURPHY) : bool
  {
...
!!!311042.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
	_completion(stm);
!!!311170.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!311298.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
