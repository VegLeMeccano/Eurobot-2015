...
!!!307074.cpp!!!	claps_replie(inout stm : MAE_MURPHY) : void
  {
...
!!!307202.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!307330.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!307458.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
