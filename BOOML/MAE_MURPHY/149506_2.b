...
#endif
    stm._mae_murphy_state._jeu_state._mission_depot_de_tour_zone_depart_state._way_point_initial_state._cap_to_mission_state.create(st!!!220546.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
E_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
	puts("DEBUG : execute entry behavior of .MAE_MURPHY.Jeu.mission depot de tour zone depart.way point initial");
#endif
// rejoindre le poin!!!220674.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
RPHY::AnyState
  return &stm._mae_murphy_state._jeu_state._mission_depot_de_tour_zon!!!219266.cpp!!!	create(inout stm : MAE_MURPHY) : void
  _doentry(stm);
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_depot_de_tour_zone_depart_state._way_point_initial_state._cap_to_mission_state);
#ifdef VERBOSE_STATE_MACHINE
