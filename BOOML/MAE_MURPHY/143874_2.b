...
#endif
    stm._mae_murphy_state._jeu_state._mission_claps_state._chope_du_coin_state._chope_gobelet_state.create(stm!!!194946.cpp!!!	create(inout stm : MAE_MURPHY) : void
) : void
	_doen!!!195074.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
if(master->is_Vert()){
// BF droite sur le gobelet 
serialPrintf(master->get!!!195202.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
: MAE_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state._mission_claps_stat!!!194818.cpp!!!	assFini(inout stm : MAE_MURPHY) : void
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_claps_state._chope_du_coin_state._chope_gobelet_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Jeu.mission claps.chope du coin.chope gobelet");
