...
!!!211970.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
	_completion(stm);
!!!212098.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
...
!!!212226.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
  return &stm._mae_murphy_state._recalage_initial_state;
!!!237954.cpp!!!	_completion(inout stm : MAE_MURPHY) : bool
  {
