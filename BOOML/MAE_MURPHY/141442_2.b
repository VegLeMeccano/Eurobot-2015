class capture_State
!!!158594.cpp!!!	time_out(inout stm : MAE_MURPHY) : void
  {
...
!!!158722.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!158850.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!158978.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
