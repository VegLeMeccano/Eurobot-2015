...
!!!184706.cpp!!!	_completion(inout stm : MAE_MURPHY) : bool

  {
    ...
    return (bool)!!!184834.cpp!!!	create(inout stm : MAE_MURPHY) : void
Y) : void
	_doentry(stm);
	_compl!!!184962.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
...
{
	master->get_gestionnaire_mission()->get_mis!!!185090.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
) : MAE_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state._missi!!!184706.cpp!!!	_completion(inout stm : MAE_MURPHY) : bool
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_pillage_distrib_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Jeu.mission pillage distrib");
