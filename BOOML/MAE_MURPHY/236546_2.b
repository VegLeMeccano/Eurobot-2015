...
!!!356610.cpp!!!	claps_replie(inout stm : MAE_MURPHY) : void
  {
...
!!!356738.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!356866.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!356994.cpp!!!	_doexit(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!357122.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
