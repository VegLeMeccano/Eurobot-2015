...
#endif
    stm._mae_murphy_state._jeu_state._mission_attrap_balle_et_chiage_state._sortie_state.create(stm!!!191234.cpp!!!	create(inout stm : MAE_MURPHY) : void
) : void
	_doen!!!191362.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
: MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
//master->get_gestionnaire_mission()->get_mission_chiage_!!!191490.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
E_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state._mission_attrap_bal!!!191106.cpp!!!	assFini(inout stm : MAE_MURPHY) : void
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_attrap_balle_et_chiage_state._sortie_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Jeu.mission attrap balle et chiage.sortie");
