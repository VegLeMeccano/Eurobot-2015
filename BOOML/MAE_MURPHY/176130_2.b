...
!!!224258.cpp!!!	pince_ouverte(inout stm : MAE_MURPHY) : void
  {
...
!!!224386.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!224514.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!224642.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
