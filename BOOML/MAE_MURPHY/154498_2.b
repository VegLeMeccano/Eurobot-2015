...
#endif
    stm._mae_murphy_state._recalage_initial_state._coup_de_patte_cote_escalier_pour_confirmer_le_sens_state.create(stm!!!241794.cpp!!!	create(inout stm : MAE_MURPHY) : void
) : void
	_doen!!!241922.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
...
if(master->is_Vert()){
	...
	serialPrintf(master->getPortSerie(),"S0 1334 996!!!242050.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
Y) : MAE_MURPHY::AnyState
  return &stm._mae_murphy_stat!!!241666.cpp!!!	time_out(inout stm : MAE_MURPHY) : void
  {
    stm._set_currentState(stm._mae_murphy_state._recalage_initial_state._coup_de_patte_cote_escalier_pour_confirmer_le_sens_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Recalage Initial.coup de patte cote escalier pour confirmer le sens");
