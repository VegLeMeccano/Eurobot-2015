...
#endif
    stm._mae_murphy_state._jeu_state._mission_claps_state._waypoint_initial_state.create(st!!!209666.cpp!!!	_exit16(inout stm : MAE_MURPHY) : void
Y) : void
  {
...
#endif
    stm._mae_murphy_state._jeu_state._decision_state.c!!!209794.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
: MAE_MURPHY::AnyState
  return &stm._mae_m!!!192386.cpp!!!	create(inout stm : MAE_MURPHY) : void
  _doentry(stm);
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_claps_state._waypoint_initial_state);
#ifdef VERBOSE_STATE_MACHINE
