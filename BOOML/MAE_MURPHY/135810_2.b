...
#endif
    stm._mae_murphy_state._jeu_state._mission_depot_tour_estrade_state._recule_doucement_state.create(stm!!!159490.cpp!!!	create(inout stm : MAE_MURPHY) : void
) : void
	_doen!!!159618.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
...
if(master->is_Vert()){
	...
	if(master->get_gestionnaire_mission()->get_mission_depot_tour_estrade()->is_depot_double())
	{
		ser!!!159746.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
URPHY) : MAE_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state._mis!!!159362.cpp!!!	pince_lache(inout stm : MAE_MURPHY) : void
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_depot_tour_estrade_state._recule_doucement_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Jeu.mission depot tour estrade.recule doucement");
