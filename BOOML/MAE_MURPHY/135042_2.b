...
#endif
    stm._mae_murphy_state._evitement_state.create(stm!!!236162.cpp!!!	create(inout stm : MAE_MURPHY) : void
) : void
  _doentry(stm);
  {
...
#endif
      stm._mae_murphy_state._jeu_state._decision_state!!!239618.cpp!!!	end_game(inout stm : MAE_MURPHY) : void
...
#endif
    stm._mae_murphy_state._!!!239746.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
	puts("DEBUG : execute entry behavior of .MAE_MURPHY.Jeu");
#endif
co!!!239874.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
stm : MAE_MURPHY) : MAE_MURPHY::A!!!164482.cpp!!!	evitement(inout stm : MAE_MURPHY) : void
  {
    stm._set_currentState(stm._mae_murphy_state._evitement_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Evitement");
