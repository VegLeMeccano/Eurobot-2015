...
#endif
    stm._mae_murphy_state._jeu_state._mission_depot_tour_estrade_state._avance_state.create(stm!!!160898.cpp!!!	create(inout stm : MAE_MURPHY) : void
) : void
	_doen!!!161026.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
...
AE_MURPHY) : MAE_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state.!!!160770.cpp!!!	pince_ready_to_drop(inout stm : MAE_MURPHY) : void
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_depot_tour_estrade_state._avance_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Jeu.mission depot tour estrade.avance");
