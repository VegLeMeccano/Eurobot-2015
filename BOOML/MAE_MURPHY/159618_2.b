...
!!!188802.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!188930.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state._mission_attrap_balle_et_chiage_state;
!!!210690.cpp!!!	blocage(inout stm : MAE_MURPHY) : void
  {
...
// set X, Y CAP??
!!!257154.cpp!!!	_doexit(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
