class deboit_les_cines_adverses_State
!!!233986.cpp!!!	_completion(inout stm : MAE_MURPHY) : bool
  {
...
!!!234114.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_completion(stm);
!!!234242.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
