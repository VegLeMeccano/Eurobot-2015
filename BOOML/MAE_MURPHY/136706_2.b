...
#endif
    stm._mae_murphy_state._jeu_state._mission_pillage_distrib_state._rejoindre_le_point_de_depart_mission_state.create(st!!!184578.cpp!!!	_exit8(inout stm : MAE_MURPHY) : void
Y) : void
  {
...
#endif
    stm._mae_murphy_state._jeu_state._decision_state.c!!!185218.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
 stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
cout<<"!!!185346.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
 : MAE_MURPHY::AnyState
  return &stm._mae_!!!164610.cpp!!!	create(inout stm : MAE_MURPHY) : void
  _doentry(stm);
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_pillage_distrib_state._rejoindre_le_point_de_depart_mission_state);
#ifdef VERBOSE_STATE_MACHINE
