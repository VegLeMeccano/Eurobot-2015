...
#endif
    stm._mae_murphy_state._jeu_state._mission_pillage_distrib_state.create(stm!!!236930.cpp!!!	mission_claps(inout stm : MAE_MURPHY) : void
) : void
  {
...
#endif
    stm._mae_murphy_state._jeu_state._mission_claps_state.cr!!!237314.cpp!!!	mission_depot_tour_depart(inout stm : MAE_MURPHY) : void
E_MURPHY) : void
  {
...
#endif
    stm._mae_murphy_state._jeu_state._mission_depot_de_tour_zone_depart_!!!237698.cpp!!!	mission_zone_ennemie(inout stm : MAE_MURPHY) : void
stm : MAE_MURPHY) : void
  {
...
#endif
    stm._mae_murphy_state._jeu_state._mission_zone_!!!238082.cpp!!!	mission_chiage_balle(inout stm : MAE_MURPHY) : void
...
#endif
    stm._mae_murphy_state._jeu_state._mission_attrap_!!!238466.cpp!!!	mission_zone_centrale(inout stm : MAE_MURPHY) : void
...
#endif
    stm._mae_murphy_state._jeu_state._mis!!!238850.cpp!!!	mission_depot_tour_estrade(inout stm : MAE_MURPHY) : void
...
#endif
    stm._mae_murphy_state._jeu_st!!!238978.cpp!!!	create(inout stm : MAE_MURPHY) : void

!!!238978.cpp!!!!239106.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
._jeu_state;
...
// consulte les mission r!!!239234.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
!239234.cpp!!!	_upper(inout stm : MAE_MURPHY!!!236546.cpp!!!	mission_distrib(inout stm : MAE_MURPHY) : void
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_pillage_distrib_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Jeu.mission pillage distrib");
