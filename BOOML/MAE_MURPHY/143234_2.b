...
#endif
    stm._mae_murphy_state._jeu_state._mission_claps_state._chope_du_stand_sur_la_route_state._ouverture_de_pince_state.create(st!!!194306.cpp!!!	_exit11(inout stm : MAE_MURPHY) : void
Y) : void
  {
...
#endif
      stm._mae_murphy_state._jeu_state._mission_claps_state._chope_!!!194434.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
...
out stm : MAE_MURPHY) : MAE_MURPHY::AnyState
  return &stm._mae_!!!194178.cpp!!!	create(inout stm : MAE_MURPHY) : void
  _doentry(stm);
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_claps_state._chope_du_stand_sur_la_route_state._ouverture_de_pince_state);
#ifdef VERBOSE_STATE_MACHINE
