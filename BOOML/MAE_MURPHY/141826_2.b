...
#endif
    stm._mae_murphy_state._jeu_state._mission_attrap_balle_et_chiage_state._point_de_depart_state._bf_droite_to_objectif_state.create(stm!!!186114.cpp!!!	create(inout stm : MAE_MURPHY) : void
) : void
	_doen!!!186242.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
m : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
cout<<"ORIENTATION!!!186370.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
MAE_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state._mission_attrap_balle_et_chiage_state._p!!!185986.cpp!!!	assFini(inout stm : MAE_MURPHY) : void
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_attrap_balle_et_chiage_state._point_de_depart_state._bf_droite_to_objectif_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Jeu.mission attrap balle et chiage.point de depart.BF droite to objectif");
