...
!!!334338.cpp!!!	pince_ouverte(inout stm : MAE_MURPHY) : void
  {
...
!!!334466.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!334594.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!334722.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
