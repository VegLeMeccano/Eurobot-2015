...
#endif
    stm._mae_murphy_state._jeu_state._mission_claps_state._chope_du_coin_state._bf_droite_sur_le_verre_state.create(st!!!198658.cpp!!!	_exit12(inout stm : MAE_MURPHY) : void
Y) : void
  {
...
#endif
      stm._mae_murphy_state._jeu_state._mission_claps_state._claps_estrade_s!!!204418.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
...
m : MAE_MURPHY) : MAE_MURPHY::AnyState
  return &stm._mae_murphy!!!194690.cpp!!!	create(inout stm : MAE_MURPHY) : void
  _doentry(stm);
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_claps_state._chope_du_coin_state._bf_droite_sur_le_verre_state);
#ifdef VERBOSE_STATE_MACHINE
