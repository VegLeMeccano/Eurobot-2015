...
!!!318338.cpp!!!	pince_range(inout stm : MAE_MURPHY) : void
  {
...
!!!318466.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!318594.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!318722.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
