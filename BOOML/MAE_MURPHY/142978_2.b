...
!!!191618.cpp!!!	_completion(inout stm : MAE_MURPHY) : bool

  {
    ...
    return (bool)!!!191746.cpp!!!	create(inout stm : MAE_MURPHY) : void
Y) : void
	_doentry(stm);
	_compl!!!191874.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
 : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
master->get_gestionnaire_mission()->get_mission_chiage_!!!192002.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
AE_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state._mission_attrap_ba!!!191618.cpp!!!	_completion(inout stm : MAE_MURPHY) : bool
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._mission_attrap_balle_et_chiage_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Jeu.mission attrap balle et chiage");
