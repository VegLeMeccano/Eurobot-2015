...
statecanvas 129154 state_ref 150914 // vidage distributeur
  show_activities default region_horizontally default drawing_language default show_stereotype_properties default
  xyzwh 1243.84 706.081 2005 267 89
end
...
statecanvas 130946 state_ref 172674 // sortie zone
  show_activities default region_horizontally default drawing_language default show_stereotype_properties default
  xyzwh 622.494 674.267 2005 553 159
end
...
pseudostatecanvas 135042 pseudostate_ref 209794 // exit_point
   xyz 1272 785 3005 label_xy 1245 804
end
...
transitioncanvas 130306 transition_ref 201346 // <transition>
  ...
  from ref 129922 z 2006 label "[master->get_gestionnaire_mission()->get_mission_distrib()->is_capture_gobelet_done()]" xyz 772 348 2006 to ref 128898
  write_horizontally default show_definition default drawing_language default
end
...
transitioncanvas 131458 transition_ref 202114 // <transition>
  ...
  from ref 131202 z 2006 label "[!master->get_gestionnaire_mission()->get_mission_distrib()->is_netoyage_zone_done() ]" xyz 781 408 2006 to ref 128898
  write_horizontally default show_definition default drawing_language default
end
...
transitioncanvas 133250 transition_ref 227970 // <transition>
  ...
  from ref 131202 z 2006 label "[master->get_gestionnaire_mission()->get_mission_distrib()->is_netoyage_zone_done() ]" xyz 636 564 2006 to ref 130946
  write_horizontally default show_definition default drawing_language default
end
