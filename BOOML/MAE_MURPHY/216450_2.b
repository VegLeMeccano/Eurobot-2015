...
!!!304002.cpp!!!	pince_range(inout stm : MAE_MURPHY) : void
  {
...
!!!304130.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!304258.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!304386.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
  return &stm._mae_murphy_state._jeu_state._mission_depot_de_tour_zone_depart_state;
!!!338690.cpp!!!	_doexit(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
