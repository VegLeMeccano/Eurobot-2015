...
#endif
    stm._mae_murphy_state._jeu_state._decision_state.create(stm!!!224514.cpp!!!	create(inout stm : MAE_MURPHY) : void
) : void
	_doen!!!224642.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
: MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
master->get_gestionnaire_mis!!!224770.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
E_MURPHY::AnyState
  return &stm._mae_murph!!!224386.cpp!!!	assFini(inout stm : MAE_MURPHY) : void
  {
    stm._set_currentState(stm._mae_murphy_state._jeu_state._decision_state);
#ifdef VERBOSE_STATE_MACHINE
    puts("DEBUG : current state is now .MAE_MURPHY.Jeu.decision");
