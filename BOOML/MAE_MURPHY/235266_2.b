class BF_CAP_State
!!!350850.cpp!!!	assFini(inout stm : MAE_MURPHY) : void
  {
...
!!!350978.cpp!!!	create(inout stm : MAE_MURPHY) : void
	_doentry(stm);
!!!351106.cpp!!!	_doentry(inout stm : MAE_MURPHY) : void
#ifdef VERBOSE_STATE_MACHINE
...
!!!351234.cpp!!!	_upper(inout stm : MAE_MURPHY) : MAE_MURPHY::AnyState
