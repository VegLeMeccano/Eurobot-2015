class Jeu_State
!!!138754.cpp!!!	create(inout stm : MAE_COOP_R) : void
  _doentry(stm);
  {
...
!!!138882.cpp!!!	_completion(inout stm : MAE_COOP_R) : bool
  {
    return (bool) 1;
  }
!!!148482.cpp!!!	_doentry(inout stm : MAE_COOP_R) : void
#ifdef VERBOSE_STATE_MACHINE
	puts("DEBUG : execute entry behavior of .MAE_COOP_R.Jeu");
#endif
cout<<"[BOUML] etat Jeu"<<endl;
cout<<"portSerie : "<<master->getPortSerie()<<endl;
!!!148610.cpp!!!	_upper(inout stm : MAE_COOP_R) : MAE_COOP_R::AnyState
